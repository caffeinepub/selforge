...
import type { SessionRecord as _SessionRecord } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addSession(arg0: string, arg1: string, arg2: bigint, arg3: bigint): Promise<bigint> {
    ...
    async getAllSessions(): Promise<Array<SessionRecord>> {
        if (this.processError) {
            try {
    ...
    async getSession(arg0: bigint): Promise<SessionRecord | null> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SessionRecord]): SessionRecord | null {
